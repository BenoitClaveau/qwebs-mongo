...
class HttpService extends Crud {
    ...
    async restGet(context, stream, headers) {
        return this.httpFindOne(context, stream, headers);
    }

    //GET /?query-string as filter
    async restFind(context, stream, headers) {
        return this.httpFind(context, stream, headers);
    }

    //POST /
    async restInsert(context, stream, headers) {
        return this.httpInsertOne(context, stream, headers);
    }

    //PUT /:id
    async restUpdate(context, stream, headers) {
        return this.httpSaveOne(context, stream, headers);
    }

    //DELETE /:id
    async restDelete(context, stream, headers) {
        return this.httpDeleteOne(context, stream, headers);
    }
