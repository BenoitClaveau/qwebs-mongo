...
class CRUDAuth extends CRUD {
    ...
    httpAuthUpdateOne(request, response) {
        return this.$auth.identify(request, response).then(() => {
            return this.httpUpdateOne(request, response);
        })
    };

    httpAuthUpdateMany(request, response) {
        return this.$auth.identify(request, response).then(() => {
            return this.httpUpdateMany(request, response);
        })
    };
    ...
    httpAuthDeleteOne(request, response) {
        return this.$auth.identify(request, response).then(() => {
            return this.httpDeleteOne(request, response);
        })
    };
