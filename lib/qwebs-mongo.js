...
var MongoClient = require('mongodb').MongoClient,
    ...
    GridStore = require('mongodb').GridStore, //obsolete
...
MongoService.prototype.update = function(collectionName, query, update, options) {
    options = options || {};
    var self = this;
    return self.connect().then(function(db) {
        var id = update._id;
...
MongoService.prototype.updateOne = function(collectionName, filter, update, options) {
    options = options || {};
    var self = this;
    return self.connect().then(function(db) {
        var id = update._id;
...
MongoService.prototype.updateMany = function(collectionName, filter, update, options) {
    options = options || {};
    var self = this;
    return self.connect().then(function(db) {
        var id = update._id;
...
MongoService.prototype.gridFSBucket = function(options) {
    options = options || {};
    var self = this;
    return self.connect().then(function(db) {
        if (self.$config.verbose) { 
...
MongoService.prototype.iterate = function(cursor, func) {
