    ...
    update(collectionName, query, update, options) {
        return this.connect().then(db => {
            ...
            return db.collection(collectionName).update(query, copy, options).then(result => {
                ...
                console.log("db." + collectionName + ".update(" + JSON.stringify(query) + ", " + JSON.stringify(copy) + ", " + JSON.stringify(options), ") => " + result + " element(s).");
                console.log();
                return result;
            });
        });
    ...
    findOne(collectionName, query, fields) {
        return this.connect().then(db => {
            ...
            return db.collection(collectionName).findOne(query, fields).then(result => {
                ...
                console.log("db." + collectionName + ".findOne(" + JSON.stringify(query) + ", " + JSON.stringify(fields) + ") => ", result);
                console.log();
                return result;
            });
        });
    ...
    ensureIndex(collectionName, index, options) {
        return this.connect().then(db => {
            ...
            return db.collection(collectionName).ensureIndex(index, options).then(result => {
                ...
                console.log("db." + collectionName + ".ensureIndex(" + JSON.stringify(index) + ", " + JSON.stringify(options) + ")");
                console.log();
                return result;
            });
        });
